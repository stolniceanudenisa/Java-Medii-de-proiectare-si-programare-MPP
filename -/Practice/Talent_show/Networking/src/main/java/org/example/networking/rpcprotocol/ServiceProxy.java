...
public class ServiceProxy implements IService {
    ...
    public Jurry getByMailPassword(String nume, String password, IObserver client) throws Exception {
        ...
        sendRequest(new Request(RequestType.GET_BY_MAIL_PASSWORD, new UserDTO(0, nume, password)));
        this.client=client;
    ...
    public void logout(Jurry user, IObserver client) throws Exception {
        sendRequest(new Request(RequestType.LOGOUT, new UserDTO(user.getId(), user.getNume(), user.getPassword())));
